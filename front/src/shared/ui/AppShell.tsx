...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  return (
    <div className='min-h-dvh flex flex-col text-white relative'>
      <div className='fixed inset-0 -z-10 bg-black' style={{ backgroundImage: 'url(/zalip%20b.gif)', backgroundSize: 'cover', backgroundPosition: 'center 0', backgroundRepeat: 'repeat-y', filter: 'brightness(0.25)' }} />
      <BackButton />
