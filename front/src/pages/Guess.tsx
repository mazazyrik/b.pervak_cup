...
export function Guess() {
  ...
  return (
    <div className='min-h-dvh px-4 py-6 flex flex-col items-center gap-4' style={{ backgroundImage: 'repeating-linear-gradient(0deg, rgba(0,0,0,0) 0, rgba(0,0,0,0) 100vh), url(https://raw.githubusercontent.com/mazazyrik/b.pervak_cup/refs/heads/main/front/public/zalip%20b.gif)', backgroundSize: 'cover, cover', backgroundPosition: 'center 0, center 0', backgroundRepeat: 'no-repeat, repeat-y' }}>
